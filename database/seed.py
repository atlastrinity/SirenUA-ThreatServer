...
def seed_initial_rules_if_empty():
    ...
    try:
        ...
        initial_rules = [
            ...
            ("launch_site_pattern", "Полігон Халіно (Курськ)", "Сумська область", "shahed",
             "Майданчик пуску [shahed] 'Полігон Халіно (Курськ)' має 98% точність застосування по напрямку Сумська область", 30, 0.98),
            ("launch_site_pattern", "Приморсько-Ахтарськ", "Запорізька область", "shahed",
             "Майданчик пуску [shahed] 'Приморсько-Ахтарськ' має 90% точність застосування по напрямку Запорізька область", 25, 0.90),
            ("aviation_strike_pattern", "Аеродром Саваслейка", "Всі області", "mig31k",
             "Авіаційний удар [mig31k] з пускового району Аеродром Саваслейка має 99% ймовірність спрямування на Всі області", 50, 0.99),
        ]
