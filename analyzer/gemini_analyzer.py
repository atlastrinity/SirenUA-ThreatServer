    ...
    def build_rules_context(self, messages_text: str = "") -> str:
        ...
        try:
            ...
            cluster_definitions = {
                ...
                "tactical_aviation": ["каб", "керован", "авіабомб", "су-34", "су-35", "су-57", "тактичн", "балтимор", "морозовськ", "бутурлинівк", "бельбек", "саки", "халіно", "сеща"],
                "drones": ["шахед", "shahed", "бпла", "дрон", "мопед", "гербер", "чауд", "приморсько-ахтарськ", "єйськ", "орел"]
            }
