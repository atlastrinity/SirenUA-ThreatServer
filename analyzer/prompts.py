...
1. **shahed (Piston UAV / БПЛА Shahed-136/131/Geran)**: Cruising Speed ~165 km/h (~2.75 km/min, MD-550 piston engine) -> Format: "~40-50 хв" or "~1-2 год"
2. **reactive_uav / jet_shahed (Jet UAV Shahed-238 / Реактивний БпЛА Shahed-238 / реактивний дрон)**: Cruising Speed ~500 km/h (~8.33 km/min, range ~450-550 km/h, micro-turbojet engine) -> Format: "~15-30 хв" or "~20-40 хв"
3. **cruise_missile (Kh-101/Kalibr / Крилата ракета)**: Cruising Speed ~850 km/h (~14.1 km/min) -> Format: "~15-25 хв" or "~35-45 хв"
4. **ballistic (Iskander-M / S-300 / S-400 / Балістика)**: Cruising Speed ~5500 km/h (~91.6 km/min) -> Format: "~2-5 хв" (critical priority)
5. **mig31k (Kinzhal / Кинджал)**: Cruising Speed ~2500 km/h (~41.6 km/min) -> Format: "~10-15 хв" or "~20-40 хв"
6. **kab (Guided Aerial Bomb / КАБ)**: Cruising Speed ~900 km/h (~15 km/min) -> Format: "~3-5 хв" (max 5-7 min flight limit)
7. **tu95 (Strategic Bomber Tu-95MS Launch)**: Cruising Speed ~800 km/h (~13.3 km/min) -> Early Notice: "~40-80 хв"
8. **tu22m3 (Strategic Supersonic Bomber Tu-22M3 / Kh-22)**: Speed ~4200 km/h (~70 km/min) -> Format: "~3-10 хв"
9. **su35_su57 (Tactical Aviation Su-34/35/57)**: Speed ~950 km/h (~15.8 km/min) -> Format: "~5-15 хв"
10. **iskander (Quasi-ballistic Iskander-M)**: Speed ~5500 km/h (~91.6 km/min) -> Format: "~2-5 хв"
11. **artillery (Artillery / Cannon shelling)**: Speed ~1200 km/h (~20 km/min) -> Format: "~0-5 хв"
12. **zircon (Hypersonic 3M22 Zircon)**: Speed ~11000 km/h (~183 km/min) -> Format: "~1-3 хв"
13. **mlrs (MLRS Tornado-S / Grad / Uragan)**: Speed ~2200 km/h (~36.6 km/min) -> Format: "~0-5 хв"
14. **fpv (FPV drone / Lancet kamikaze)**: Speed ~140 km/h (~2.33 km/min) -> Format: "~5-15 хв"
15. **recon / recon_uav (Reconnaissance Drone Supercam/Orlan/Zala)**: Speed ~120 km/h (~2.0 km/min) -> Format: "~15-30 хв"
16. **official_alarm (Official regional air siren)**: Format: "-"
17. **unknown (Generic air threat)**: Speed ~300 km/h (~5.0 km/min) -> Format: "~15-30 хв"
...
FOR ACTIVE THREATS (is_clear: false):
{
  ...
  "threat_type": "shahed" | "reactive_uav" | "jet_shahed" | "cruise_missile" | "ballistic" | "mig31k" | "kab" | "tu95" | "tu22m3" | "su35_su57" | "iskander" | "artillery" | "zircon" | "mlrs" | "fpv" | "recon" | "recon_uav" | "official_alarm" | "unknown" | null,
