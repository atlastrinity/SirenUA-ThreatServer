...
BALLISTIC_LAUNCH_SITES: Dict[str, Dict[str, Any]] = {
    ...
    BALLISTIC_SITE_BELGOROD: {
        "title": "Бєлгородський рубіж (Бєлгородська обл. РФ)",
        "primary_threat": THREAT_BALLISTIC,
    ...
    BALLISTIC_SITE_KURSK: {
        "title": "Курський рубіж (Курська обл. РФ)",
        "primary_threat": THREAT_BALLISTIC,
    ...
    BALLISTIC_SITE_BRYANSK: {
        "title": "Брянський рубіж (Брянська обл. РФ)",
        "primary_threat": THREAT_BALLISTIC,
    ...
    BALLISTIC_SITE_VORONEZH: {
        "title": "Воронезький рубіж (Воронезька обл. РФ)",
        "primary_threat": THREAT_BALLISTIC,
    ...
    BALLISTIC_SITE_ROSTOV: {
        "title": "Ростовський рубіж (Ростовська обл. РФ)",
        "primary_threat": THREAT_BALLISTIC,
    ...
    BALLISTIC_SITE_TOT_ZAPORIZHZHIA: {
        "title": "Рубіж ТОТ Запорізької обл. (Бердянськ/Мелітополь)",
        "primary_threat": THREAT_BALLISTIC,
...
AVIATION_LAUNCH_SECTORS: Dict[str, Dict[str, Any]] = {
    ...
    SECTOR_VORONEZH: {
        "title": "Воронезький рубіж (Воронезька обл. РФ)",
        "lat_lon": (51.66, 39.20),
        "target_regions": ["Харківська область", "Полтавська область", "Дніпропетровська область", "Луганська область"],
...
def resolve_aviation_strike_profile(
    ...
    if threat_type in [THREAT_BALLISTIC, THREAT_ISKANDER, "iskander", "ballistic", "bastion", "onyx"]:
        ...
        if not ballistic_site_key:
            if target_region in ["Одеська область", "Миколаївська область"]:
                ballistic_site_key = BALLISTIC_SITE_TARKHANKUT
                sector_key = SECTOR_BLACK_SEA
            elif target_region in ["Херсонська область", "Запорізька область", "Дніпропетровська область"]:
                ballistic_site_key = BALLISTIC_SITE_DZHANkOY if "джанкой" in text_lower else BALLISTIC_SITE_TARKHANKUT
                sector_key = SECTOR_CHAUDA
