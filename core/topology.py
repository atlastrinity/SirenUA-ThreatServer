...
REGION_CENTROIDS = {
    ...
    "Запорізька область": (46.75, 36.30),    # Азовський напрямок / Південний кордон
    ...
    "Миколаївська область": (46.60, 31.50),  # Чорноморське узбережжя / акваторія
    "Одеська область": (45.75, 30.30),       # Чорноморське узбережжя / акваторія
    "Полтавська область": (49.59, 34.55),
    "Рівненська область": (50.62, 26.25),
    "Сумська область": (51.32, 34.85),       # Прикордонний рух (вхід з Курщини/РФ)
    "Тернопільська область": (49.55, 25.6),
    "Харківська область": (50.30, 36.40),    # Прикордонний рух (вхід з Бєлгородщини/РФ)
    "Херсонська область": (46.00, 34.20),    # Прикордонний рух (вхід з Криму/Азовського моря)
    "Хмельницька область": (49.42, 27.0),
    "Черкаська область": (49.44, 32.06),
    "Чернівецька область": (48.3, 25.94),
    "Чернігівська область": (52.05, 31.50),  # Прикордонний рух (вхід з Брянщини/РФ)
    "АР Крим": (45.00, 35.83),               # Мис Чауда / Акваторія Криму
}
