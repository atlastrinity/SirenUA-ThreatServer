...
async def seed_history():
    ...
    from database.db_helpers import get_sqlite_connection, backup_sqlite_to_firestore
    ...
    threat_configs = [
        {"threat_level": "high", "threat_type": "shahed", "speed": 185, "altitude": "low", "origin": "Приморсько-Ахтарськ РФ", "vector": "Південь -> Центр", "detail": "Група ударних БпЛА типу Shahed курсом на область"},
        ...
        {"threat_level": "critical", "threat_type": "ballistic", "speed": 4500, "altitude": "high", "origin": "АР Крим", "vector": "Крим -> Південь/Центр", "detail": "Загроза застосування балістичного озброєння з південного напрямку"},
        {"threat_level": "medium", "threat_type": "kab", "speed": 950, "altitude": "medium", "origin": "Бєлгородська обл. РФ", "vector": "Прикордоння -> Область", "detail": "Пуски керованих авіабомб тактичною авіацією ворога"}
    ]
...
async def get_admin_errors_stats(days: int = 7):
    ...
    try:
        tz_modifier = get_kyiv_tz_modifier()
